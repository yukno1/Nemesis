								...
								<table className="w-full text-left text-sm">
									...
									<tbody className="divide-y divide-smoke/40">
										{providers.map((p) => (
											<tr
												key={p.id}
												className="transition-colors hover:bg-graphite/40"
											>
												<td className="px-4 py-2.5 font-mono text-lime">
													{p.code}
												</td>
												...
												<td className="px-4 py-2.5">
													<div className="flex justify-end gap-3 text-xs whitespace-nowrap">
														<button
															type="button"
									...
									<tbody className="divide-y divide-smoke/40">
										{models.map((m) => (
											...
											>
												...
												<td className="px-4 py-2.5 font-mono text-xs text-mist">
													{m.model_name}
												</td>
												<td className="px-4 py-2.5">
				...
				<div className="grid grid-cols-2 gap-3">
					...
					<div>
						...
						<Select
							...
							onChange={(e) =>
								patchModel({ type: e.target.value as ModelType })
							}
						>
					...
					<div>
						...
						<Input
							...
							onChange={(e) =>
								patchModel({ context_window: toNum(e.target.value) })
							}
						/>
					</div>
					<div>
						...
						<Input
							...
							onChange={(e) =>
								patchModel({ max_output: toNum(e.target.value) })
							}
						/>
					</div>
					<div>
						...
						<Input
							...
							onChange={(e) =>
								patchModel({ input_price: toNum(e.target.value) })
							}
						/>
					</div>
					<div>
						...
						<Input
							...
							onChange={(e) =>
								patchModel({ output_price: toNum(e.target.value) })
							}
						/>
					</div>
					<div className="col-span-2">
						...
						<div className="flex gap-5">
							{CAP_DEFS.map((cap) => (
								<label
									key={cap.key}
									className="flex cursor-pointer items-center gap-1.5 text-sm text-mist"
								>
									<input
										type="checkbox"
										className="accent-lime"
